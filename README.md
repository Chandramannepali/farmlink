...
<p align="center">
  <a href="https://www.farmlink.me" target="_blank">
    <img src="https://img.shields.io/badge/🌐 Live Demo-farmlink.me-green?style=for-the-badge" alt="Live Demo" />
  </a>
</p>

> 🚀 **Live at:** [https://www.farmlink.me](https://www.farmlink.me)
...
![Framer Motion](https://img.shields.io/badge/Framer_Motion-12.x-EF0079?style=flat-square&logo=framer&logoColor=white)
![Recharts](https://img.shields.io/badge/Charts-Recharts-22C55E?style=flat-square)
![ElevenLabs](https://img.shields.io/badge/Voice-ElevenLabs-black?style=flat-square)
...
FarmLink is an AI-powered, farm-to-consumer marketplace platform that bridges the gap between rural farmers and urban consumers across India. Built with **React + TypeScript + Vite** and powered by **Supabase**, it eliminates traditional middlemen so farmers earn more and consumers get fresher produce at fair prices.

The platform supports three distinct user roles — **Farmer**, **Consumer**, and **Admin** — each with a fully dedicated dashboard. Farmers can list produce, scan crop quality with AI, get AI-driven price predictions, monitor live weather for their farm location, and chat directly with buyers. Consumers can browse fresh produce, track orders end-to-end with QR-based traceability, and message farmers directly.

A standout feature is the **AI Voice Assistant**, powered by ElevenLabs and Bhashini, which enables farmers and consumers with no digital literacy to use the entire app by voice in their regional Indian language — removing one of the biggest barriers to technology adoption in rural India.
